<?php
ob_start();
define('API_KEY','267304104:AAGbFFjGbfJ-LKFZWqatocH1IiAhg1suJKs');
$admin = "188383245";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'saleh','url'=>'https://telegram.me/sudoAm']
        ],
        [
          ['text'=>'hack','url'=>'https://telegram.me/cd_tp']
        ]
      ]
    ])
  ]);
